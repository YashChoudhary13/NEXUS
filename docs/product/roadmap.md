...
| **Phase 1 — Multi-account Chat foundation** | [`../plans/phase-1-multi-account-chat.md`](../plans/phase-1-multi-account-chat.md) | `[IN PROGRESS]` — PR-1A open; PR-1B/1C/1D are draft PRs #2–#4; PR-1F/1E locally verified and being published as clean dependency stacks. Integration, final owner matrix, review/merge, and billing acceptance remain |
...
PR-1B/1C/1D are draft PRs #2–#4, and PR-1F/1E are locally verified. Stacked publication,
integrated regression/user acceptance, review, and merge remain.
